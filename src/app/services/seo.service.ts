...
const DEFAULT_DESCRIPTION = 'Thaqalayn is a free, open digital library of authentic Shia Islamic primary texts — the Holy Quran and the major Shia hadith collections — with Arabic originals, multiple English translations, narrator chains, and scholarly references.';
